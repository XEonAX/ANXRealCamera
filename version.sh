...
sed -i "s/$(cat ./src/ANXOppoCameraMagisk/module.prop|grep versionCode=|tr -d " ")/versionCode=${ANXVERSIONNUMBER}/g" ./src/ANXOppoCameraMagisk/module.prop
sed -i "s/$(cat ./src/ANXOppoCameraMagisk/module.prop|grep version=|tr -d " ")/version=${ANXVERSION}/g" ./src/ANXOppoCameraMagisk/module.prop
