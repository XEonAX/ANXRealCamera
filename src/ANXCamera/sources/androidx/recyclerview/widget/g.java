...
class g extends RecyclerView.h implements RecyclerView.m {
    ...
    final StateListDrawable f971a;

    /* renamed from: b  reason: collision with root package name */
    final Drawable f972b;
    int c;
    int d;
    float e;
    int f;
    ...
    private class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            g.this.f971a.setAlpha(floatValue);
            g.this.f972b.setAlpha(floatValue);
            g.this.a();
        }
    }
    ...
    g(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
        ...
        this.m = i3;
        this.n = i4;
        this.f971a.setAlpha(255);
        this.f972b.setAlpha(255);
    ...
    private void a(Canvas canvas) {
        ...
        int i6 = this.c;
        int i7 = i5 - (i6 / 2);
        this.f971a.setBounds(0, 0, i3, i6);
        this.f972b.setBounds(0, 0, this.p, this.v);
        if (e()) {
            this.f972b.draw(canvas);
