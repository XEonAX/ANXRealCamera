...
public class k {
    ...
    private static Map<Class, Integer> f766a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static Map<Class, List<Constructor<? extends c>>> f767b = new HashMap();
    ...
    private static int b(Class<?> cls) {
        Integer num = f766a.get(cls);
        if (num != null) {
            return num.intValue();
        }
        int c = c(cls);
        f766a.put(cls, Integer.valueOf(c));
        return c;
    }
    ...
    private static int c(Class<?> cls) {
        ...
        if (a2 != null) {
            f767b.put(cls, Collections.singletonList(a2));
            return 2;
        } else if (a.f754a.a(cls)) {
            return 1;
        } else {
            ...
            if (d(superclass)) {
                ...
                arrayList = new ArrayList(f767b.get(superclass));
            }
            for (Class cls2 : cls.getInterfaces()) {
                if (d(cls2)) {
                    ...
                    arrayList.addAll(f767b.get(cls2));
                }
            }
            if (arrayList == null) {
                return 1;
            }
            f767b.put(cls, arrayList);
            return 2;
        }
    }
