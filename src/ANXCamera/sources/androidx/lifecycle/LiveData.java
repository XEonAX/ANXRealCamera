...
public abstract class LiveData<T> {
    ...
    static final Object f746b = new Object();

    /* renamed from: a  reason: collision with root package name */
    final Object f747a = new Object();
    int c = 0;
    volatile Object d;
    ...
    class LifecycleBoundObserver extends LiveData<T>.a implements d {
        ...
        public void a(h hVar, e.a aVar) {
            if (this.f749a.b().a() == e.b.DESTROYED) {
        ...
        public boolean a() {
            return this.f749a.b().a().isAtLeast(e.b.STARTED);
        }

        /* access modifiers changed from: package-private */
        public boolean a(h hVar) {
            return this.f749a == hVar;
        }
        ...
        this.j = new Runnable() {
            public void run() {
                ...
                synchronized (LiveData.this.f747a) {
                    obj = LiveData.this.d;
                    LiveData.this.d = LiveData.f746b;
                }
                LiveData.this.a(obj);
            }
        };
