...
class y {
    ...
    private static final RectF f418a = new RectF();

    /* renamed from: b  reason: collision with root package name */
    private static ConcurrentHashMap<String, Method> f419b = new ConcurrentHashMap<>();
    ...
    private StaticLayout b(CharSequence charSequence, Layout.Alignment alignment, int i2) {
        CharSequence charSequence2 = charSequence;
        StaticLayout staticLayout = new StaticLayout(charSequence2, this.k, i2, alignment, ((Float) b((Object) this.l, "mSpacingMult", Float.valueOf(1.0f))).floatValue(), ((Float) b((Object) this.l, "mSpacingAdd", Float.valueOf(0.0f))).floatValue(), ((Boolean) b((Object) this.l, "mIncludePad", true)).booleanValue());
        return staticLayout;
    }
    ...
    private StaticLayout b(CharSequence charSequence, Layout.Alignment alignment, int i2, int i3) {
        ...
        try {
            obtain.setTextDirection(Build.VERSION.SDK_INT >= 29 ? this.l.getTextDirectionHeuristic() : (TextDirectionHeuristic) a((Object) this.l, "getTextDirectionHeuristic", TextDirectionHeuristics.FIRSTSTRONG_LTR));
        ...
        if (g()) {
            if (this.e) {
                if (this.l.getMeasuredHeight() > 0 && this.l.getMeasuredWidth() > 0) {
                    int measuredWidth = Build.VERSION.SDK_INT >= 29 ? this.l.isHorizontallyScrollable() : ((Boolean) a((Object) this.l, "getHorizontallyScrolling", false)).booleanValue() ? 1048576 : (this.l.getMeasuredWidth() - this.l.getTotalPaddingLeft()) - this.l.getTotalPaddingRight();
                    int height = (this.l.getHeight() - this.l.getCompoundPaddingBottom()) - this.l.getCompoundPaddingTop();
                    if (measuredWidth > 0 && height > 0) {
                        synchronized (f418a) {
                            f418a.setEmpty();
                            f418a.right = (float) measuredWidth;
                            f418a.bottom = (float) height;
                            float a2 = (float) a(f418a);
