...
public class ActionBarOverlayLayout extends ViewGroup implements aa, m, n, o {
    static final int[] e = {R.attr.actionBarSize, 16842841};
    private final Runnable A;
    private final p B;

    /* renamed from: a  reason: collision with root package name */
    ActionBarContainer f218a;
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.d = new AnimatorListenerAdapter() {
            public void onAnimationCancel(Animator animator) {
                ...
                actionBarOverlayLayout.f219b = false;
            }
        ...
        this.z = new Runnable() {
            public void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.c = actionBarOverlayLayout.f218a.animate().translationY(0.0f).setListener(ActionBarOverlayLayout.this.d);
            }
        };
        this.A = new Runnable() {
            public void run() {
                ActionBarOverlayLayout.this.d();
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.c = actionBarOverlayLayout.f218a.animate().translationY((float) (-ActionBarOverlayLayout.this.f218a.getHeight())).setListener(ActionBarOverlayLayout.this.d);
            }
        };
        a(context);
        this.B = new p(this);
    ...
    private boolean a(float f2, float f3) {
        this.y.fling(0, 0, 0, (int) f3, 0, 0, MessageNano.UNSET_ENUM_VALUE, Integer.MAX_VALUE);
        return this.y.getFinalY() > this.f218a.getHeight();
    }
    ...
    public void c() {
        if (this.h == null) {
            ...
            this.f218a = (ActionBarContainer) findViewById(R.id.action_bar_container);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.j != null && !this.k) {
            int bottom = this.f218a.getVisibility() == 0 ? (int) (((float) this.f218a.getBottom()) + this.f218a.getTranslationY() + 0.5f) : 0;
    ...
    public boolean fitSystemWindows(Rect rect) {
        c();
        int o2 = u.o(this) & 256;
        boolean a2 = a((View) this.f218a, rect, true, true, false, true);
        this.t.set(rect);
    ...
    public int getActionBarHideOffset() {
        ActionBarContainer actionBarContainer = this.f218a;
    ...
    public void onMeasure(int i2, int i3) {
        int i4;
        c();
        measureChildWithMargins(this.f218a, i2, 0, i3, 0);
        b bVar = (b) this.f218a.getLayoutParams();
        int max = Math.max(0, this.f218a.getMeasuredWidth() + bVar.leftMargin + bVar.rightMargin);
        int max2 = Math.max(0, this.f218a.getMeasuredHeight() + bVar.topMargin + bVar.bottomMargin);
        int combineMeasuredStates = View.combineMeasuredStates(0, this.f218a.getMeasuredState());
        boolean z2 = (u.o(this) & 256) != 0;
        if (z2) {
            i4 = this.f;
            if (this.m && this.f218a.getTabContainer() != null) {
                i4 += this.f;
            }
        } else {
            i4 = this.f218a.getVisibility() != 8 ? this.f218a.getMeasuredHeight() : 0;
        }
        this.s.set(this.q);
        this.v.set(this.t);
        if (this.l || z2) {
    ...
    public boolean onStartNestedScroll(View view, View view2, int i2) {
        if ((i2 & 2) == 0 || this.f218a.getVisibility() != 0) {
            return false;
        }
        return this.n;
    }
    ...
    public void onStopNestedScroll(View view) {
        if (this.n && !this.f219b) {
            if (this.o <= this.f218a.getHeight()) {
                l();
            } else {
                m();
            }
    ...
    public void setActionBarHideOffset(int i2) {
        d();
        this.f218a.setTranslationY((float) (-Math.max(0, Math.min(i2, this.f218a.getHeight()))));
    }
