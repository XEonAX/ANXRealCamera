...
public class ActionBarContextView extends a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i2) {
        ...
        au a2 = au.a(context, attributeSet, R.styleable.ActionMode, i2, 0);
    ...
    public void a(final b bVar) {
        ...
        gVar.a((m) this.d, this.f300b);
        this.c = (ActionMenuView) this.d.a((ViewGroup) this);
        u.a((View) this.c, (Drawable) null);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i5, MessageNano.UNSET_ENUM_VALUE);
            View view = this.i;
            if (view != null) {
