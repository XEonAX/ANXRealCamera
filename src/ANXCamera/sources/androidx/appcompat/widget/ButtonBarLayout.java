...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f262a = obtainStyledAttributes.getBoolean(R.styleable.ButtonBarLayout_allowStacking, true);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (a() || View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            i3 = View.MeasureSpec.makeMeasureSpec(size, MessageNano.UNSET_ENUM_VALUE);
            z = true;
        }
    ...
    public void setAllowStacking(boolean z) {
        if (this.f262a != z) {
            this.f262a = z;
            if (!this.f262a && getOrientation() == 1) {
                setStacked(false);
            }
            requestLayout();
        }
