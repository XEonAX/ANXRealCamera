...
public class g extends MenuInflater {
    ...
    static final Class<?>[] f150a = {Context.class};

    /* renamed from: b  reason: collision with root package name */
    static final Class<?>[] f151b = f150a;
    final Object[] c;
    ...
    private static class a implements MenuItem.OnMenuItemClickListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final Class<?>[] f152a = {MenuItem.class};
        ...
        public a(Object obj, String str) {
            ...
            try {
                this.c = cls.getMethod(str, f152a);
            } catch (Exception e) {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            try {
                if (this.c.getReturnType() == Boolean.TYPE) {
                    return ((Boolean) this.c.invoke(this.f153b, new Object[]{menuItem})).booleanValue();
                }
                this.c.invoke(this.f153b, new Object[]{menuItem});
                return true;
            } catch (Exception e) {
    ...
    private class b {
        ...
        private void a(MenuItem menuItem) {
            ...
            String str = this.z;
            if (str != null) {
                menuItem.setActionView((View) a(str, g.f150a, g.this.c));
                z2 = true;
            }
            int i3 = this.y;
            if (i3 > 0) {
            ...
            androidx.core.g.b bVar = this.f154a;
            if (bVar != null) {
        ...
        public void b(AttributeSet attributeSet) {
            au a2 = au.a(g.this.e, attributeSet, R.styleable.MenuItem);
            this.k = a2.g(R.styleable.MenuItem_android_id, 0);
            this.l = (a2.a(R.styleable.MenuItem_android_menuCategory, this.e) & -65536) | (a2.a(R.styleable.MenuItem_android_orderInCategory, this.f) & 65535);
            ...
            if (z2 && this.y == 0 && this.z == null) {
                this.f154a = (androidx.core.g.b) a(this.A, g.f151b, g.this.d);
            } else {
                if (z2) {
            ...
            if (a2.g(R.styleable.MenuItem_iconTintMode)) {
                this.F = ac.a(a2.a(R.styleable.MenuItem_iconTintMode, -1), this.F);
            } else {
                this.F = null;
            }
                ...
                if (i != 2) {
                    if (i == 3) {
                        ...
                        if (z2 && name.equals(str)) {
                            ...
                            if (!bVar.d()) {
                                if (bVar.f154a == null || !bVar.f154a.c()) {
                                    bVar.b();
                                } else {
                                    bVar.c();
                                }
