...
class d extends b {
        ...
        while (true) {
            ...
            if (next2 != 1) {
                ...
                if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                    ...
                    if (resourceId > 0) {
                        drawable = ak.a().a(context, resourceId);
                    }
                    a2.recycle();
    ...
    /* renamed from: b */
    public a c() {
        return new a(this.f136a, this, (Resources) null);
    }
    ...
    public Drawable mutate() {
        if (!this.f137b && super.mutate() == this) {
            this.f136a.a();
            this.f137b = true;
        }
        return this;
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        int b2 = this.f136a.b(iArr);
        if (b2 < 0) {
            b2 = this.f136a.b(StateSet.WILD_CARD);
        }
