...
public class l {
    ...
    private ViewParent f564a;

    /* renamed from: b  reason: collision with root package name */
    private ViewParent f565b;
    ...
    private void a(int i, ViewParent viewParent) {
        if (i == 0) {
            this.f564a = viewParent;
        } else if (i == 1) {
            this.f565b = viewParent;
        }
    }
    ...
    private boolean b(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (a()) {
            ...
            if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
                ...
                x.a(d2, this.c, i, i2, i3, i4, i5, iArr3);
                if (iArr4 != null) {
                    this.c.getLocationInWindow(iArr4);
                    iArr4[0] = iArr4[0] - i7;
                    iArr4[1] = iArr4[1] - i6;
    ...
    public boolean a(int i, int i2) {
        ...
        for (ViewParent parent = this.c.getParent(); parent != null; parent = parent.getParent()) {
            if (x.a(parent, view, this.c, i, i2)) {
                a(i2, parent);
                x.b(parent, view, this.c, i, i2);
                return true;
            }
