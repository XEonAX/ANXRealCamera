...
class h {
    ...
    private ConcurrentHashMap<Long, c.b> f609a = new ConcurrentHashMap<>();
    ...
    private c.C0010c a(c.b bVar, int i) {
        return (c.C0010c) a(bVar.a(), i, new a<c.C0010c>() {
            /* renamed from: a */
            public int b(c.C0010c cVar) {
                return cVar.b();
            }

            /* renamed from: b */
            public boolean a(c.C0010c cVar) {
                return cVar.c();
            }
        });
    }
    ...
    private void a(Typeface typeface, c.b bVar) {
        long b2 = b(typeface);
        if (b2 != 0) {
            this.f609a.put(Long.valueOf(b2), bVar);
        }
    }
    ...
    public Typeface a(Context context, c.b bVar, Resources resources, int i) {
        c.C0010c a2 = a(bVar, i);
        if (a2 == null) {
            return null;
        }
        Typeface a3 = c.a(context, resources, a2.f(), a2.a(), i);
        a(a3, bVar);
        return a3;
    }
    ...
    public c.b a(Typeface typeface) {
        ...
        return this.f609a.get(Long.valueOf(b2));
    }

    /* access modifiers changed from: protected */
    public b.C0012b a(b.C0012b[] bVarArr, int i) {
        return (b.C0012b) a(bVarArr, i, new a<b.C0012b>() {
            /* renamed from: a */
            public int b(b.C0012b bVar) {
                return bVar.c();
            }

            /* renamed from: b */
            public boolean a(b.C0012b bVar) {
                return bVar.d();
            }
        });
    }
