...
public class e<K, V> {
    ...
    private final LinkedHashMap<K, V> f430a;
    ...
    public e(int i) {
        if (i > 0) {
            this.c = i;
            this.f430a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public void a(int i) {
        ...
        while (true) {
            synchronized (this) {
                if (this.f431b < 0 || (this.f430a.isEmpty() && this.f431b != 0)) {
                } else if (this.f431b > i) {
                    if (this.f430a.isEmpty()) {
                        break;
                    }
                    Map.Entry next = this.f430a.entrySet().iterator().next();
                    key = next.getKey();
                    value = next.getValue();
                    this.f430a.remove(key);
                    this.f431b -= c(key, value);
                    this.f++;
                }
            }
