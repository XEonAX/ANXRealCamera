...
public class b {
    ...
    private static final ThreadLocal<Matrix> f457a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f458b = new ThreadLocal<>();

    static void a(ViewGroup viewGroup, View view, Rect rect) {
        Matrix matrix = f457a.get();
        if (matrix == null) {
            matrix = new Matrix();
            f457a.set(matrix);
        } else {
