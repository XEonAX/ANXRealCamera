...
public abstract class DialogPreference extends Preference {
    ...
    public DialogPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.f804a = g.b(obtainStyledAttributes, R.styleable.DialogPreference_dialogTitle, R.styleable.DialogPreference_android_dialogTitle);
        if (this.f804a == null) {
            this.f804a = x();
        }
        this.f805b = g.b(obtainStyledAttributes, R.styleable.DialogPreference_dialogMessage, R.styleable.DialogPreference_android_dialogMessage);
