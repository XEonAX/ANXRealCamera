...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", "B", "H", "F", OppoExifInterface.GpsStatus.INTEROPERABILITY, OppoExifInterface.GpsLongitudeRef.WEST, " "};
    private static final String[] L_T_K_S_N_M_B_Z = {"L", OppoExifInterface.GpsTrackRef.TRUE_DIRECTION, OppoExifInterface.GpsSpeedRef.KILOMETERS, OppoExifInterface.GpsLatitudeRef.SOUTH, "N", "M", "B", "Z"};
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH")) {
            if (!contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID")) {
                int i2 = i + 2;
                if (!contains(str, i2, 1, OppoExifInterface.GpsTrackRef.TRUE_DIRECTION, OppoExifInterface.GpsLatitudeRef.SOUTH)) {
                    if (!contains(str, i - 1, 1, OppoExifInterface.GpsStatus.IN_PROGRESS, "O", "U", OppoExifInterface.GpsLongitudeRef.EAST) && i != 0) {
                        return false;
                    }
    ...
    private boolean conditionL0(String str, int i) {
        ...
        return (contains(str, str.length() - 2, 2, "AS", "OS") || contains(str, str.length() - 1, 1, OppoExifInterface.GpsStatus.IN_PROGRESS, "O")) && contains(str, i - 1, 4, "ALLE");
    }
                ...
                if (contains(str2, i3, 3, "CIA")) {
                    ...
                    if (contains(str, i, 2, "CK", "CG", "CQ")) {
                        ...
                        if (!contains(str, i3, 2, " C", " Q", " G")) {
                            if (!contains(str, i3, 1, "C", OppoExifInterface.GpsSpeedRef.KILOMETERS, "Q") || contains(str2, i3, 2, "CE", "CI")) {
                                return i3;
                            }
                        }
    ...
    private int handleCC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        int i2 = i + 2;
        if (!contains(str, i2, 1, "I", OppoExifInterface.GpsLongitudeRef.EAST, "H") || contains(str, i2, 2, "HU")) {
    ...
    private int handleD(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (contains(str, i, 2, "DG")) {
            int i2 = i + 2;
            if (contains(str, i2, 1, "I", OppoExifInterface.GpsLongitudeRef.EAST, "Y")) {
        ...
        if (charAt(str2, i4) == 'N') {
            ...
            if (contains(str2, i4, 2, "ER") || charAt(str2, i4) == 'Y') {
                ...
                if (!contains(str, 0, 6, "DANGER", "RANGER", "MANGER")) {
                    int i5 = i3 - 1;
                    if (!contains(str2, i5, 1, OppoExifInterface.GpsLongitudeRef.EAST, "I") && !contains(str2, i5, 3, "RGY", "OGY")) {
            ...
            if (contains(str, i4, 1, OppoExifInterface.GpsLongitudeRef.EAST, "I", "Y") || contains(str2, i3 - 1, 4, "AGGI", "OGGI")) {
        ...
        if (i2 > 0 && !isVowel(charAt(str2, i2 - 1))) {
            ...
            if (i2 <= 3 || !contains(str2, i2 - 4, 1, "B", "H")) {
                if (i2 > 2 && charAt(str2, i2 - 1) == 'U') {
                    if (contains(str, i2 - 3, 1, "C", "G", "L", "R", OppoExifInterface.GpsTrackRef.TRUE_DIRECTION)) {
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i2 != 0 || contains(str, i2, 4, "JOSE")) {
            ...
            if (i2 == str.length() - 1) {
                doubleMetaphoneResult.append('J', ' ');
            } else if (!contains(str, i2 + 1, 1, L_T_K_S_N_M_B_Z) && !contains(str, i3, 1, OppoExifInterface.GpsLatitudeRef.SOUTH, OppoExifInterface.GpsSpeedRef.KILOMETERS, "L")) {
                doubleMetaphoneResult.append('J');
            }
        } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x007b, code lost:
        if (contains(r16, r9 + 1, 1, "M", "N", "L", com.oppo.exif.OppoExifInterface.GpsLongitudeRef.WEST) == false) goto L_0x007d;
     */
            ...
            if (i2 != 0 || !contains(str2, i2, 5, "SUGAR")) {
                if (contains(str2, i2, 2, "SH")) {
                    ...
                    if (!contains(str2, i3, 1, "Z")) {
                        ...
                        if (!contains(str2, i3, 1, OppoExifInterface.GpsLatitudeRef.SOUTH, "Z")) {
                            return i3;
                        }
                    }
                    doubleMetaphoneResult2.append('S', 'X');
    ...
    private int handleSC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        } else if (contains(str, i2, 1, "I", OppoExifInterface.GpsLongitudeRef.EAST, "Y")) {
            doubleMetaphoneResult2.append('S');
        } else {
            doubleMetaphoneResult2.append("SK");
        }
    ...
    private int handleT(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (contains(str, i, 4, "TION")) {
            ...
            doubleMetaphoneResult.append('T');
            int i3 = i + 1;
            return contains(str, i3, 1, OppoExifInterface.GpsTrackRef.TRUE_DIRECTION, "D") ? i + 2 : i3;
        }
        return i + 3;
    }
    ...
    private int handleZ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (contains(str, i2, 2, "ZO", "ZI", "ZA") || (z && i > 0 && charAt(str, i - 1) != 'T')) {
            doubleMetaphoneResult.append(OppoExifInterface.GpsLatitudeRef.SOUTH, "TS");
        } else {
            doubleMetaphoneResult.append('S');
        }
        if (charAt(str, i2) == 'Z') {
