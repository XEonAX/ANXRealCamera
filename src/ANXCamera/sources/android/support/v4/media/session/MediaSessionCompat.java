...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((e.a) message.obj);
                }
            }
        }
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        if (mediaSessionImplApi21 != null) {
                            ...
                            d.a(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, r1);
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(e.a aVar) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((e.a) null);
                }
            }
        }
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            if (!(mediaSessionImpl == null || this.mCallbackHandler == null)) {
                ...
                if (keyEvent != null && keyEvent.getAction() == 0) {
                    e.a currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(e.a aVar);
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (!MediaSessionImplApi21.this.mDestroyed) {
                    ...
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new e.a(callingPackage, getCallingPid(), getCallingUid()));
                }
            }
        ...
        public e.a getCurrentControllerInfo() {
            return null;
        }
        ...
        public void setCurrentControllerInfo(e.a aVar) {
        }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final e.a getCurrentControllerInfo() {
            return new e.a(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private i.a mVolumeCallback = new i.a() {
            public void onVolumeChanged(i iVar) {
                if (MediaSessionImplBase.this.mVolumeProvider == iVar) {
                    ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(MediaSessionImplBase.this.mVolumeType, MediaSessionImplBase.this.mLocalStream, iVar.b(), iVar.c(), iVar.a());
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new e.a("android.media.session.MediaController", getCallingPid(), getCallingUid()));
                }
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    MediaSessionImplBase.this.setCurrentControllerInfo(new e.a(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((e.a) null);
                    }
                }
            }
        }
        ...
        public void setPlaybackToRemote(i iVar) {
            if (iVar != null) {
                ...
                ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.b(), this.mVolumeProvider.c(), this.mVolumeProvider.a());
                sendVolumeInfoChanged(parcelableVolumeInfo);
