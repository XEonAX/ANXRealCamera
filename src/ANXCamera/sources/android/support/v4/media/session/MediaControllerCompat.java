...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData extends e.a {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(d.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        if (activity instanceof e) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((e) activity).a(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof e) {
            ((e) activity).a((e.a) new MediaControllerExtraData(mediaControllerCompat));
        }
        if (Build.VERSION.SDK_INT >= 21) {
            Object obj = null;
