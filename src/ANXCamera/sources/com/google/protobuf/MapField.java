...
public class MapField<K, V> implements MutabilityOracle {
    ...
    public static <K, V> MapField<K, V> emptyMapField(MapEntry<K, V> mapEntry) {
        return new MapField<>(mapEntry, StorageMode.MAP, (Map<K, V>) Collections.emptyMap());
    }

    public static <K, V> MapField<K, V> newMapField(MapEntry<K, V> mapEntry) {
        return new MapField<>(mapEntry, StorageMode.MAP, (Map<K, V>) new LinkedHashMap());
    }
    ...
    public MapField<K, V> copy() {
        return new MapField<>(this.converter, StorageMode.MAP, (Map<K, V>) MapFieldLite.copy(getMap()));
    }
