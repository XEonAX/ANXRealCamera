    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        private Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            for (int i2 = 0; i2 < descriptorProto.getOneofDeclCount(); i2++) {
                ...
                OneofDescriptor oneofDescriptor = new OneofDescriptor(descriptorProto.getOneofDecl(i2), fileDescriptor, this, i2, (AnonymousClass1) null);
            ...
            for (int i4 = 0; i4 < descriptorProto.getEnumTypeCount(); i4++) {
                ...
                EnumDescriptor enumDescriptor = new EnumDescriptor(descriptorProto.getEnumType(i4), fileDescriptor, this, i4, (AnonymousClass1) null);
            ...
            for (int i5 = 0; i5 < descriptorProto.getFieldCount(); i5++) {
                ...
                FieldDescriptor fieldDescriptor = new FieldDescriptor(descriptorProto.getField(i5), fileDescriptor, this, i5, false, (AnonymousClass1) null);
            ...
            for (int i6 = 0; i6 < descriptorProto.getExtensionCount(); i6++) {
                ...
                FieldDescriptor fieldDescriptor2 = new FieldDescriptor(descriptorProto.getExtension(i6), fileDescriptor, this, i6, true, (AnonymousClass1) null);
            ...
            for (int i7 = 0; i7 < descriptorProto.getOneofDeclCount(); i7++) {
                ...
                FieldDescriptor[] unused = oneofDescriptorArr2[i7].fields = new FieldDescriptor[oneofDescriptorArr2[i7].getFieldCount()];
    ...
    public static final class EnumDescriptor extends GenericDescriptor implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        private EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            if (enumDescriptorProto.getValueCount() != 0) {
                ...
                for (int i2 = 0; i2 < enumDescriptorProto.getValueCount(); i2++) {
                    ...
                    EnumValueDescriptor enumValueDescriptor = new EnumValueDescriptor(enumDescriptorProto.getValue(i2), fileDescriptor, this, i2, (AnonymousClass1) null);
        ...
        public EnumValueDescriptor findValueByNumberCreatingIfUnknown(int i) {
            ...
            synchronized (this) {
                ...
                WeakReference weakReference = this.unknownValues.get(num);
            ...
            if (getNumber() > 0) {
                if (z) {
                    ...
                    if (!fieldDescriptorProto.hasOneofIndex()) {
                        ...
                        int unused = this.containingOneof.fieldCount = containingOneof.fieldCount + 1;
                    }
                    this.extensionScope = null;
                } else {
    ...
    public static final class FileDescriptor extends GenericDescriptor {
        ...
        private FileDescriptor(DescriptorProtos.FileDescriptorProto fileDescriptorProto, FileDescriptor[] fileDescriptorArr, DescriptorPool descriptorPool, boolean z) throws DescriptorValidationException {
            ...
            for (int i2 = 0; i2 < fileDescriptorProto.getMessageTypeCount(); i2++) {
                ...
                Descriptor descriptor = new Descriptor(fileDescriptorProto.getMessageType(i2), this, (Descriptor) null, i2, (AnonymousClass1) null);
                descriptorArr[i2] = descriptor;
            }
            this.enumTypes = new EnumDescriptor[fileDescriptorProto.getEnumTypeCount()];
            for (int i3 = 0; i3 < fileDescriptorProto.getEnumTypeCount(); i3++) {
                EnumDescriptor[] enumDescriptorArr = this.enumTypes;
                EnumDescriptor enumDescriptor = new EnumDescriptor(fileDescriptorProto.getEnumType(i3), this, (Descriptor) null, i3, (AnonymousClass1) null);
            ...
            for (int i5 = 0; i5 < fileDescriptorProto.getExtensionCount(); i5++) {
                ...
                FieldDescriptor fieldDescriptor = new FieldDescriptor(fileDescriptorProto.getExtension(i5), this, (Descriptor) null, i5, true, (AnonymousClass1) null);
                fieldDescriptorArr[i5] = fieldDescriptor;
            }
        }
    ...
    public static final class ServiceDescriptor extends GenericDescriptor {
        ...
        private ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i) throws DescriptorValidationException {
            ...
            for (int i2 = 0; i2 < serviceDescriptorProto.getMethodCount(); i2++) {
                ...
                MethodDescriptor methodDescriptor = new MethodDescriptor(serviceDescriptorProto.getMethod(i2), fileDescriptor, this, i2, (AnonymousClass1) null);
