...
public class e {
    ...
    public e(Context context, AttributeSet attributeSet, int[] iArr, int i2, int i3) {
        ...
        this.f1487a = obtainStyledAttributes.getColor(R.styleable.ColorHintRedDot_colorHintRedDotColor, 0);
        this.f1488b = obtainStyledAttributes.getColor(R.styleable.ColorHintRedDot_colorHintRedDotTextColor, 0);
        ...
        this.n.setColor(this.f1488b);
        this.n.setTextSize((float) this.c);
        this.o = new Paint();
        this.o.setAntiAlias(true);
        this.o.setColor(this.f1487a);
    ...
    private void a(Canvas canvas, int i2, RectF rectF) {
        if (i2 > 0) {
            canvas.drawPath(h.a().a(rectF, (float) this.i), this.o);
            if (i2 < 1000) {
                String valueOf = String.valueOf(i2);
                Paint.FontMetricsInt fontMetricsInt = this.n.getFontMetricsInt();
                canvas.drawText(valueOf, (float) ((int) (rectF.left + (((rectF.right - rectF.left) - ((float) ((int) this.n.measureText(valueOf)))) / 2.0f))), (float) (((int) (((rectF.top + rectF.bottom) - ((float) fontMetricsInt.ascent)) - ((float) fontMetricsInt.descent))) / 2), this.n);
                return;
            }
            ...
            for (int i3 = -1; i3 <= 1; i3++) {
                int i4 = this.m;
                int i5 = this.l;
                canvas.drawCircle(((float) ((i4 + i5) * i3)) + f2, f3, ((float) i5) / 2.0f, this.n);
            }
        }
    }
    ...
    private int b(int i2) {
        return i2 < 10 ? this.d : i2 < 100 ? this.e : i2 < 1000 ? this.f : this.e;
    }
