...
public class ColorRoundImageView extends ImageView {
    ...
    private final RectF f1622a;

    /* renamed from: b  reason: collision with root package name */
    private final RectF f1623b;
    private int c;
    private Context d;
    private boolean e;
    private boolean f;
    ...
    public void a() {
        this.f1623b.set(0.0f, 0.0f, (float) this.m, (float) this.n);
        this.t = this.m - this.o;
        this.f1622a.set(this.f1623b);
    ...
    public Bitmap b() {
        ...
        Canvas canvas = new Canvas(createBitmap);
        this.g = this.o / 2;
        canvas.drawPath(h.a().a(this.f1622a, (float) this.g), this.u);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i3 == 0) {
            ...
            if (this.e) {
                canvas.drawPath(h.a().a(this.h, (float) this.g), this.u);
                canvas.drawPath(h.a().a(this.h, (float) this.g), this.u);
                canvas.drawPath(h.a().a(this.i, ((float) this.g) - 1.0f), this.v);
                return;
            }
            canvas.drawPath(h.a().a(this.h, (float) this.g), this.u);
        }
