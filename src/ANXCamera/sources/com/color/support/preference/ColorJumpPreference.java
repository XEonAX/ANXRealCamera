...
public class ColorJumpPreference extends ColorPreference {
    ...
    public ColorJumpPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.f1506b = obtainStyledAttributes.getText(R.styleable.ColorJumpPreference_color_jump_status1);
    ...
    public void a(l lVar) {
        ...
        View a3 = lVar.a(R.id.color_preference);
        if (a3 != null) {
            int i = this.f;
            if (i != 0) {
                if (i == 1) {
        ...
        if (textView != null) {
            CharSequence charSequence = this.f1506b;
