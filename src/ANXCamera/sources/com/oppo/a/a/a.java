...
public interface a extends IInterface {
    ...
    /* compiled from: IPreDecode */
    public static abstract class C0050a extends Binder implements a {
        ...
        private static class C0051a implements a {
            ...
            public static a f1747a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f1748b;
            ...
            public Bitmap a(ParcelFileDescriptor parcelFileDescriptor, int i, int i2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    if (!this.f1748b.transact(4, obtain, obtain2, 0) && C0050a.a() != null) {
                        return C0050a.a().a(parcelFileDescriptor, i, i2);
                    }
            ...
            public Bitmap a(String str, int i, int i2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    if (!this.f1748b.transact(3, obtain, obtain2, 0) && C0050a.a() != null) {
                        return C0050a.a().a(str, i, i2);
                    }
                    obtain2.readException();
                    Bitmap bitmap = obtain2.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(obtain2) : null;
                    obtain2.recycle();
            ...
            public Bitmap a(String str, String str2, long j, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeLong(j);
                    obtain.writeInt(i);
                    if (!this.f1748b.transact(2, obtain, obtain2, 0) && C0050a.a() != null) {
                        return C0050a.a().a(str, str2, j, i);
                    }
                    obtain2.readException();
                    Bitmap bitmap = obtain2.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(obtain2) : null;
                    obtain2.recycle();
            ...
            public void a(String str, String str2, long j, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f1748b.transact(1, obtain, (Parcel) null, 1) || C0050a.a() == null) {
                        obtain.recycle();
                    } else {
                        C0050a.a().a(str, str2, j, z);
                    }
                } finally {
                    obtain.recycle();
                }
