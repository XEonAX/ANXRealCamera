...
public class OppoFaceBeauty {
    ...
    public static class ProcessParameter {
        ...
        public int[] mBeauty3DParam = null;
        public int mBeauty3DParamSize = 0;
        ...
        public byte[] mSensorName = new byte[24];
    ...
    public int initialize(InitParameter initParameter) {
        ...
        d.a(TAG, "initialize, result: " + init);
        if (init != 0) {
            this.mHandle = init;
        }
        return (int) init;
    ...
    public int processSplitYUV(byte[] bArr, byte[] bArr2, ImageInfo imageInfo, ProcessParameter processParameter) {
        d.a(TAG, "process, mHandle: " + this.mHandle);
        long j = this.mHandle;
        if (j != 0) {
    ...
    public int release() {
        d.a(TAG, "release, mHandle: " + this.mHandle);
        long j = this.mHandle;
        if (j != 0) {
            return release(j);
        }
    ...
    public void setDebug(DebugParameter debugParameter) {
        d.a(TAG, "setDebug, mHandle: " + this.mHandle + ", parameter: " + debugParameter);
        long j = this.mHandle;
        if (j != 0) {
