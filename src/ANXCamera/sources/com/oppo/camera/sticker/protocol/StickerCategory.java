...
public final class StickerCategory extends Message<StickerCategory, Builder> {
    ...
    public static final class Builder extends Message.Builder<StickerCategory, Builder> {
        ...
        public StickerCategory build() {
            StickerCategory stickerCategory = new StickerCategory(this.id, this.readableId, this.name, this.sticker, this.iconPath, this.iconMd5, this.highlightIconPath, this.highlightIconMd5, this.position, this.isNew, super.buildUnknownFields());
    ...
    public StickerCategory(Long l, String str, String str2, List<Sticker> list, String str3, String str4, String str5, String str6, Integer num, Boolean bool, ByteString byteString) {
        ...
        this.readableId = str;
        this.name = str2;
        this.sticker = Internal.immutableCopyOf("sticker", list);
        this.iconPath = str3;
        this.iconMd5 = str4;
    ...
    public Builder newBuilder() {
        ...
        builder.sticker = Internal.copyOf("sticker", this.sticker);
