...
public final class StickerRequest extends Message<StickerRequest, Builder> {
    ...
    public static final class Builder extends Message.Builder<StickerRequest, Builder> {
        ...
        public StickerRequest build() {
            StickerRequest stickerRequest = new StickerRequest(this.imei, this.model, this.resResolution, this.protocolVersion, this.clientVersion, this.colorosVersion, this.androidVersion, this.otaVersion, this.locale, this.localDataVersion, this.compatibleApp, super.buildUnknownFields());
