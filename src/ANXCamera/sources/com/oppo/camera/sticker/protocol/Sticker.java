...
public final class Sticker extends Message<Sticker, Builder> {
    ...
    public static final class Builder extends Message.Builder<Sticker, Builder> {
        ...
        public Sticker build() {
            Sticker sticker = new Sticker(this.id, this.uuid, this.name, this.filePath, this.fileMd5, this.thumbnailPath, this.thumbnailMd5, this.version, this.logoPath, this.logoMd5, this.hasMusic, this.position, this.compatibleApp, this.isNew, this.materialType, super.buildUnknownFields());
            return sticker;
        }
