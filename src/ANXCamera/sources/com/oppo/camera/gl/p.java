...
public class p {
    ...
    private static final float[] f2179a = {1.0f, -1.0f, 1.0f, 1.0f, -1.0f, -1.0f, -1.0f, 1.0f};

    /* renamed from: b  reason: collision with root package name */
    private static final float[] f2180b = {-1.0f, 1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f, -1.0f};
    ...
    private int n = d.e().getResources().getDimensionPixelSize(R.dimen.thumbnail_width_nomal);
    ...
    public p() {
        ...
        if (glCreateShader != 0) {
            ...
            if (iArr[0] == 0) {
                com.oppo.camera.d.e("NoMoireThumbGenerator", "loadShader, Could not compile shader 37305: " + GLES31.glGetShaderInfoLog(glCreateShader));
        ...
        if (glCreateProgram != 0) {
            ...
            if (1 != iArr2[0]) {
                com.oppo.camera.d.e("NoMoireThumbGenerator", "createProgram, Could not link program: " + GLES31.glGetProgramInfoLog(glCreateProgram));
                GLES31.glDeleteProgram(glCreateProgram);
            }
        }
        this.h = glCreateProgram;
        j.a(this.k, this.l, this.n, this.o);
    }
    ...
    private void a(int i2, int i3, int i4, int[] iArr, int i5, int i6, int i7, int i8) {
        ...
        FloatBuffer a2 = j.a(this.i);
        FloatBuffer a3 = j.a(this.j);
    ...
    public Bitmap a(int i2, int i3, int i4) {
        ...
        Bitmap a2 = d.a(this.n, this.o, Bitmap.Config.ARGB_8888);
