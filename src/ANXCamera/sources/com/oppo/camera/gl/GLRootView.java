...
public class GLRootView extends q implements m, q.m, r {

    /* renamed from: a  reason: collision with root package name */
    private final e f2144a;

    /* renamed from: b  reason: collision with root package name */
    private final ArrayList<f> f2145b;
    /* access modifiers changed from: private */
    public final ArrayDeque<m.a> c;
    ...
    private class IdleRunner implements Runnable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0025, code lost:
            ...
            com.oppo.camera.gl.GLRootView.b(r3.f2146a).lock();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0045, code lost:
            if (r1.a(com.oppo.camera.gl.GLRootView.c(r3.f2146a), com.oppo.camera.gl.GLRootView.d(r3.f2146a)) != false) goto L_0x0058;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0057, code lost:
            return;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x0058, code lost:
            com.oppo.camera.gl.GLRootView.b(r3.f2146a).unlock();
            android.util.Log.v("GLRootView", "IdleRunner run, mRenderLock.unlock()");
            r0 = com.oppo.camera.gl.GLRootView.a(r3.f2146a);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x006e, code lost:
            monitor-enter(r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:19:?, code lost:
            com.oppo.camera.gl.GLRootView.a(r3.f2146a).addLast(r1);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:20:0x007e, code lost:
            if (com.oppo.camera.gl.GLRootView.d(r3.f2146a) != false) goto L_0x0083;
         */
        ...
        public void run() {
            synchronized (GLRootView.this.c) {
                ...
                if (!GLRootView.this.c.isEmpty()) {
                    m.a aVar = (m.a) GLRootView.this.c.removeFirst();
                }
            }
        }
    }
    ...
    public GLRootView(Context context, AttributeSet attributeSet) {
        ...
        setEGLConfigChooser((q.e) this.f2144a);
        setRenderer(this);
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i2, int i3, int i4) {
        ...
        d.a("GLRootView", "surfaceChanged, w: " + i3 + ", h: " + i4);
    }

    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        e();
        super.surfaceCreated(surfaceHolder);
        d.a("GLRootView", "surfaceCreated");
    }

    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        e();
        super.surfaceDestroyed(surfaceHolder);
        d.a("GLRootView", "surfaceDestroyed");
    }
}
