...
public class a {
    ...
    public void a(String str, int[] iArr) {
        if (this.c != null) {
            ...
            if (hashCode != -2059329478) {
                if (hashCode != -1021190549) {
                    if (hashCode == -286799850 && str.equals("com.oppo.beauty3d.analyses.ffd")) {
                        c2 = 1;
                    }
                } else if (str.equals("com.oppo.beauty3d.analyses.result")) {
                    c2 = 0;
                }
            } else if (str.equals("com.oppo.beauty3d.custom.result")) {
                c2 = 2;
            }
            if (c2 != 0) {
                if (c2 != 1) {
                ...
                } else if (this.c.o() == 1 || (this.c.o() == 2 && !this.f1838a)) {
                    this.c.b(iArr);
                    if (this.c.o() == 2) {
