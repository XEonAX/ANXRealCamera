...
public class YuvProcessUtil {
    ...
    public static class ExifInfo {
        ...
        public static final int LOCATION_MULTIPLE = 10000;
        public static final int LOCATION_ORIGIN = 1;
    ...
    static {
        System.loadLibrary("OppoYuvProcessUtil");
    }

    public static native void bindCpuCores(long j);

    public static native byte[] mirrorIonYUV(NativeBufferProducer.NativeBufferInfo nativeBufferInfo, int[] iArr, int[] iArr2, int i, int i2, int i3);
    ...
    public native byte[] compressIonYUVtoJpeg(NativeBufferProducer.NativeBufferInfo nativeBufferInfo, int i, int[] iArr, int[] iArr2, int i2, int i3, int i4, int i5, boolean z, boolean z2, boolean z3, int i6);
