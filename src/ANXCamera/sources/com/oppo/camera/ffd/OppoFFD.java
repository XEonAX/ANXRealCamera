...
public class OppoFFD {
    ...
    public int initialize(int i, String str) {
        ...
        d.a(TAG, "initialize, faceInfoMode: " + i + ", modelPath: " + str + ", result: " + init);
        if (init != 0) {
            this.mHandle = init;
        }
        return (int) init;
    ...
    public int process(byte[] bArr, ImageInfo imageInfo, ProcessParameter processParameter) {
        ...
        d.a(TAG, "process, yuvBuffer: " + bArr + ", imageInfo: " + imageInfo + ", parameter: " + processParameter);
        return process;
    }
    ...
    public int processSplitYUV(byte[] bArr, byte[] bArr2, ImageInfo imageInfo, ProcessParameter processParameter) {
        ...
        d.a(TAG, "process, mHandle: " + this.mHandle + ", yBuffer: " + bArr + ", uvBuffer: " + bArr2 + ", imageInfo: " + imageInfo + ", parameter: " + processParameter + ", result: " + processSplitYUV);
    ...
    public int release() {
        ...
        d.a(TAG, "release, mHandle: " + this.mHandle + ", result: " + release);
        return release;
    }
    ...
    public int setDebug(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        d.a(TAG, "setDebug, mHandle: " + this.mHandle + ", fbDump: " + z + ", drawMarks: " + z2 + ", printAttr: " + z3 + ", printFFD: " + z4 + ", result: " + debug);
        return debug;
    }
}
