    ...
    public static final class AddrInfo extends GeneratedMessageV3 implements AddrInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements AddrInfoOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                ...
                try {
                    AddrInfo parsePartialFrom = AddrInfo.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    addrInfo = (AddrInfo) e.getUnfinishedMessage();
    ...
    public static final class LocInfo extends GeneratedMessageV3 implements LocInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements LocInfoOrBuilder {
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                ...
                try {
                    LocInfo parsePartialFrom = LocInfo.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (parsePartialFrom != null) {
                        mergeFrom(parsePartialFrom);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    locInfo = (LocInfo) e.getUnfinishedMessage();
                    throw e.unwrapIOException();
                } catch (Throwable th) {
                    th = th;
                    locInfo2 = locInfo;
        ...
        public boolean equals(Object obj) {
            ...
            return z13 && this.unknownFields.equals(locInfo.unknownFields);
        }
    ...
    public static final class UserInfo extends GeneratedMessageV3 implements UserInfoOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements UserInfoOrBuilder {
            ...
            public Builder mergeAddrInfo(AddrInfo addrInfo) {
                ...
                if (singleFieldBuilderV3 == null) {
                    if ((this.bitField0_ & 1) == 1) {
                        AddrInfo addrInfo2 = this.addrInfo_;
                        if (!(addrInfo2 == null || addrInfo2 == AddrInfo.getDefaultInstance())) {
            ...
            public Builder mergeGps(LocInfo locInfo) {
                ...
                if (singleFieldBuilderV3 == null) {
                    if ((this.bitField0_ & 2) == 2) {
                        LocInfo locInfo2 = this.gps_;
                        if (!(locInfo2 == null || locInfo2 == LocInfo.getDefaultInstance())) {
            ...
            while (!z) {
                try {
                    ...
                    if (readTag != 0) {
                        ? r5 = 0;
                        if (readTag == 10) {
                            r5 = (this.bitField0_ & 1) == 1 ? this.addrInfo_.toBuilder() : r5;
                            this.addrInfo_ = (AddrInfo) codedInputStream.readMessage(AddrInfo.PARSER, extensionRegistryLite);
                            if (r5 != 0) {
                                r5.mergeFrom(this.addrInfo_);
                                this.addrInfo_ = r5.buildPartial();
                            }
                            this.bitField0_ |= 1;
                        } else if (readTag == 18) {
                            r5 = (this.bitField0_ & 2) == 2 ? this.gps_.toBuilder() : r5;
                            this.gps_ = (LocInfo) codedInputStream.readMessage(LocInfo.PARSER, extensionRegistryLite);
                            if (r5 != 0) {
                                r5.mergeFrom(this.gps_);
                                this.gps_ = r5.buildPartial();
                            }
                            this.bitField0_ |= 2;
                        } else if (!parseUnknownField(codedInputStream, newBuilder, extensionRegistryLite, readTag)) {
                        }
