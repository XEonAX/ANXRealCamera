...
public class CameraStatisticsUtil extends NearMeStatistics {
    ...
    public static final String PORTRAIT_SHUTTER_TYPE = "shutter_type";
    ...
    public static void onCommon(Context context, String str, String str2, boolean z) {
        String str3;
        if (d.T()) {
            com.oppo.camera.d.b(TAG, "onCommon, monkey is running do not report");
            return;
        }
        ...
        switch (str.hashCode()) {
            ...
            case 3127582:
                ...
                break;
            case 88409418:
                if (str.equals(EVENT_STICKER_DOWNLOAD)) {
                    c = 5;
                    break;
                }
                break;
        ...
        NearMeStatistics.onCommon(context, str3, str, putEventMap, z);
    }
    ...
    public static void setSessionTimeOut(Context context, int i) {
        NearMeStatistics.setSessionTimeOut(context, i);
    }
}
