...
import com.oppo.camera.ui.menu.levelcontrol.j;
...
public class b {
    ...
    private static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public FloatBuffer f2726a;

        /* renamed from: b  reason: collision with root package name */
        public FloatBuffer f2727b;
    ...
    private a a(double d2, float f2, float f3, int i2) {
        ...
        while (true) {
            ...
            if (Math.ceil(d4) < d3) {
                ...
                a aVar = new a();
                aVar.f2726a = asFloatBuffer;
                aVar.f2727b = asFloatBuffer2;
                return aVar;
            }
        }
    }
    ...
    public void a() {
        d.a("HeadlineDrawer", "initialize");
        a a2 = a((double) this.q, this.r, 270.0f, 20);
        this.m = a2.f2726a;
        this.o = this.m.remaining() / 3;
        this.n = a2.f2727b;
        this.f2724a = j.a(j.a("headline_vertex.sh", this.f.getResources()), j.a("headline_frag.sh", this.f.getResources()));
        this.c = GLES20.glGetAttribLocation(this.f2724a, "aPosition");
        this.f2725b = GLES20.glGetUniformLocation(this.f2724a, "uMVPMatrix");
        this.d = GLES20.glGetAttribLocation(this.f2724a, "aTexCoor");
        this.e = GLES20.glGetUniformLocation(this.f2724a, "uAlpha");
        this.g = GLES20.glGetUniformLocation(this.f2724a, "uPreviousStart");
        this.h = GLES20.glGetUniformLocation(this.f2724a, "uPreviousEnd");
        this.i = GLES20.glGetUniformLocation(this.f2724a, "uPreviousRatio");
        this.j = GLES20.glGetUniformLocation(this.f2724a, "uNextStart");
        this.k = GLES20.glGetUniformLocation(this.f2724a, "uNextEnd");
        this.l = GLES20.glGetUniformLocation(this.f2724a, "uNextRatio");
    }

    public void a(float f2) {
        d.a("HeadlineDrawer", "setAlpha, alpha: " + f2);
        this.p = f2;
    }

    public void a(float f2, float f3) {
        d.a("HeadlineDrawer", "setPreviousTabLocation, start: " + f2 + ", end: " + f3);
        this.s = f2;
        this.t = f3;
    }

    public void a(int i2, float[] fArr) {
        GLES20.glUseProgram(this.f2724a);
        ...
        GLES20.glUniformMatrix4fv(this.f2725b, 1, false, fArr, 0);
    ...
    public void b(float f2) {
        d.a("HeadlineDrawer", "setPreviousAnimationRatio, ratio: " + f2);
        this.u = f2;
    }

    public void b(float f2, float f3) {
        d.a("HeadlineDrawer", "setNextTabLocation, start: " + f2 + ", end: " + f3);
        this.v = f2;
        this.w = f3;
    }

    public void c(float f2) {
        d.a("HeadlineDrawer", "setNextAnimationRatio, ratio: " + f2);
        this.x = f2;
    }
}
