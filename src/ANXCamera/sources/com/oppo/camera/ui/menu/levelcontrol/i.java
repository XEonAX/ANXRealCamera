...
public class i {
    ...
    private void a(Context context) {
        this.i = j.a("vertex_tex.sh", context.getResources());
        this.j = j.a("frag_tex.sh", context.getResources());
        this.f2799a = j.a(this.i, this.j);
        this.c = GLES20.glGetAttribLocation(this.f2799a, "aPosition");
        this.d = GLES20.glGetAttribLocation(this.f2799a, "aTexCoor");
        this.f2800b = GLES20.glGetUniformLocation(this.f2799a, "uMVPMatrix");
        this.f = GLES20.glGetUniformLocation(this.f2799a, "uCamera");
        this.g = GLES20.glGetUniformLocation(this.f2799a, "uLightLocation");
        this.e = GLES20.glGetUniformLocation(this.f2799a, "uMMatrix");
    }
    ...
    public void a(int i2, int i3) {
        int i4 = i3;
        GLES20.glUseProgram(this.f2799a);
        GLES20.glUniformMatrix4fv(this.f2800b, 1, false, h.d(), 0);
