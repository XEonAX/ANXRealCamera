...
public class h {
    ...
    private static float[] f2797a = new float[16];

    /* renamed from: b  reason: collision with root package name */
    private static float[] f2798b = new float[16];
    ...
    public static void a(float f2, float f3, float f4, float f5, float f6, float f7) {
        Matrix.orthoM(f2798b, 0, f2, f3, f4, f5, f6, f7);
    }
    ...
    public static float[] d() {
        Matrix.multiplyMM(f2797a, 0, c, 0, d, 0);
        float[] fArr = f2797a;
        Matrix.multiplyMM(fArr, 0, f2798b, 0, fArr, 0);
        return f2797a;
    }
