...
public class i extends View {
    ...
    private static String f2971a = "GradienterView";
    ...
    private void a(Canvas canvas) {
        ...
        canvas.rotate((float) this.f2972b, (float) this.g, (float) this.h);
        int i6 = this.g;
        float f6 = (float) i6;
        int i7 = this.h;
        float f7 = (float) i7;
    ...
    private void setVisibilityWithAnimation(final int i2) {
        if (!this.o) {
            d.a((View) this, i2, (Animation.AnimationListener) new Animation.AnimationListener() {
                public void onAnimationEnd(Animation animation) {
                    i.this.setVisibility(i2);
                    boolean unused = i.this.o = false;
                }
    ...
    public void a() {
        String str = f2971a;
        com.oppo.camera.d.b(str, "showWithAnimation, mOrientation: " + this.f2972b);
        int i2 = this.f2972b;
        if (i2 % 90 > 75 || i2 % 90 < 15) {
            int i3 = this.f2972b;
            if (i3 % 90 > 89 || Math.abs(i3 % 90) < 1) {
                this.c.setColor(this.f.getResources().getColor(R.color.gradienter_baseline_color));
            } else {
                this.c.setColor(-1);
            }
            invalidate();
    ...
    public void b() {
        com.oppo.camera.d.b(f2971a, "hideWithAnimation");
    ...
    public String getGradienterStatus() {
        int i2 = this.f2972b;
        if (i2 % 90 <= 75 && i2 % 90 >= 15) {
            return OppoExifInterface.GpsMeasureMode.MODE_3_DIMENSIONAL;
        }
        int i3 = this.f2972b;
        return (i3 % 90 > 89 || Math.abs(i3 % 90) < 1) ? MenuClickMsgData.VALUE_SLOGAN_CONTENT_EXIST : OppoExifInterface.GpsMeasureMode.MODE_2_DIMENSIONAL;
    }
