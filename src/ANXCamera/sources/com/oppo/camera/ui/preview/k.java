...
public class k implements b {
    ...
    private static final float[] f2982a = {70.0f, 110.0f};

    /* renamed from: b  reason: collision with root package name */
    private static final float[] f2983b = {0.2f, 0.25f};
    ...
    public k() {
        a aVar = new a(0.27f, 0.5f, 0.25f, 1.0f);
        this.h = aVar;
        this.i = 0.0f;
        this.j = null;
        this.k = 0.0f;
    ...
    private void a(h hVar, float f2, float f3) {
        ...
        if (fArr[0] <= f3 && f3 <= fArr[1]) {
            float abs = (Math.abs(90.0f - f3) * this.l) + f2983b[0];
            hVar.a(abs);
            this.n = abs;
        }
    }
    ...
    public boolean a(h hVar, int i2, int i3, int i4, int i5, c cVar) {
        ...
        if (this.m <= 0.5f && interpolation > 0.5f) {
    ...
    public boolean b(h hVar, int i2, int i3, int i4, int i5, c cVar) {
        ...
        if (i6 != 0) {
            ...
            d.e("SwitchAnimManager", "mPreviewFrameLayoutWidth is 0.");
            f2 = 1.0f;
        }
