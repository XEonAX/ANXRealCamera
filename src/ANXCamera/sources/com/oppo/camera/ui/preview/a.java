...
public class a {
    ...
    public a(Activity activity, ViewGroup viewGroup, i iVar) {
        ...
        this.c = iVar;
        this.n = this.f2872a.getResources().getDimensionPixelSize(R.dimen.camera_hint_margin);
        this.q = (int) (((double) d.N()) * 1.3333333333333333d);
    }
    ...
    private int a(View view) {
        ...
        view.measure(d.N(), d.N());
        return view.getWidth();
    }

    private C0071a a(int i2, int i3) {
        if (this.i == null) {
            this.i = new C0071a();
        }
        this.i.b(-1);
        ...
        switch (i2) {
            ...
            case 11:
                ...
                break;
            case 12:
                com.oppo.camera.d.b("AISceneUI", "getDataByAIScene, subCode: " + i3);
    ...
    private void h() {
        if (this.d == null && this.f2873b != null) {
            this.f2872a.getLayoutInflater().inflate(R.layout.ai_scene_layout, this.f2873b);
            this.d = (RelativeLayout) this.f2872a.findViewById(R.id.ai_scene_layout);
            ...
            if (imageView != null) {
                imageView.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        com.oppo.camera.d.b("AISceneUI", "mAISceneCloseView, onClick, code: " + view.getTag());
                        if (a.this.l != null) {
    ...
    public void a() {
        ...
        RelativeLayout relativeLayout = this.d;
        if (relativeLayout != null) {
            ViewGroup viewGroup = this.f2873b;
            if (viewGroup != null) {
        ...
        if (this.d != null) {
            ...
            if (!this.u) {
                ...
                if (i2 == 90) {
                    ...
                    layoutParams.topMargin = (((this.q - measuredHeight) - this.o) / 2) + d.E();
                } else if (i2 != 270) {
                    layoutParams.addRule(10);
                    layoutParams.addRule(11);
                    layoutParams.topMargin = d.E() + this.n + this.p;
                    layoutParams.rightMargin = ((d.N() - measuredWidth) - this.o) / 2;
                } else {
                    layoutParams.addRule(11);
                    layoutParams.addRule(10);
