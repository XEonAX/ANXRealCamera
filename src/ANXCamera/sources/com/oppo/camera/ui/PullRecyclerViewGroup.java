...
public class PullRecyclerViewGroup extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void a() {
        if (this.f2533b) {
            try {
                d dVar = new d(this.d, d.i);
                e eVar = new e(0.0f);
                eVar.a(350.0f);
                eVar.b(0.79f);
                dVar.a(eVar);
                dVar.a((b.C0023b) new b.C0023b() {
    ...
    private boolean b() {
        ...
        if (((LinearLayoutManager) this.d.getLayoutManager()).p() != 0 && adapter.b() != 0) {
            return false;
        }
        return ((this.d.getChildCount() <= 0 || this.d.getChildAt(0) == null) ? 0 : this.d.getChildAt(0).getLeft()) >= 0;
    }
    ...
    private boolean c() {
        ...
        int b2 = adapter.b() - 1;
        int r = ((LinearLayoutManager) this.d.getLayoutManager()).r();
        if (r >= b2) {
            View childAt = this.d.getChildAt(Math.min(r - ((LinearLayoutManager) this.d.getLayoutManager()).p(), this.d.getChildCount() - 1));
            if (childAt != null) {
                return childAt.getRight() <= this.d.getRight() - this.d.getLeft();
            }
        }
        return false;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 3 && this.f2533b) {
                a();
            }
            return true;
        } else {
            int x = (int) (motionEvent.getX() - this.f2532a);
            if (a(x)) {
