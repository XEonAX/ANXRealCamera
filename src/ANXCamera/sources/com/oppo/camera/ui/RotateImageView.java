...
public class RotateImageView extends j {
    ...
    public void a(int i, boolean z) {
        ...
        if (i2 != this.c) {
            this.c = i2;
            if (this.e) {
                this.f2539b = this.f2538a;
                this.f = AnimationUtils.currentAnimationTimeMillis();
                int i3 = this.c - this.f2538a;
                if (i3 < 0) {
                    i3 += 360;
                }
                if (i3 > 180) {
            ...
            if (i != 0 && i2 != 0) {
                if (this.f2538a != this.c) {
                    ...
                    if (currentAnimationTimeMillis < this.g) {
                        ...
                        this.f2538a = i5 >= 0 ? i5 % 360 : (i5 % 360) + 360;
                        invalidate();
                    } else {
                        this.f2538a = this.c;
                    }
                ...
                canvas.rotate((float) (-this.f2538a));
