...
public class ExposureControlSeekBar extends View {
    ...
    public ExposureControlSeekBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLinePaint.setPathEffect(new DashPathEffect(new float[]{(float) resources.getDimensionPixelSize(R.dimen.focus_view_exporebar_dash_width), (float) resources.getDimensionPixelSize(R.dimen.focus_view_exporebar_dash_gap)}, 0.0f));
        this.mLinePaint.setColor(Color.parseColor("#FFCC00"));
    ...
    private void initProgressBar() {
        this.mBottomDrawable = this.mContext.getResources().getDrawable(R.drawable.exposure_control_bar_bottom);
        setProgress(50.0f);
    }
