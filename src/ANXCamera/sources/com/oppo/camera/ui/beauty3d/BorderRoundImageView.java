...
public class BorderRoundImageView extends ImageView {
    ...
    public BorderRoundImageView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.h = obtainStyledAttributes.getColor(0, context.getColor(R.color.beauty3d_text_color));
        obtainStyledAttributes.recycle();
        this.f2543b.setStyle(Paint.Style.STROKE);
        this.f2543b.setStrokeWidth(this.g);
        this.f2543b.setColor(this.h);
    }
    ...
    private Bitmap a(Drawable drawable) {
        ...
        Bitmap a2 = d.a(bounds.right - bounds.left, bounds.bottom - bounds.top, Bitmap.Config.ARGB_8888);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (a2 != null) {
            ...
            this.f2542a.setShader(this.e);
            float f3 = ((float) min) / 2.0f;
            if (this.i) {
                canvas.drawCircle(f3, f3, f3 - (this.g / 2.0f), this.f2543b);
            }
            float f4 = this.g;
            canvas.translate(f4, f4);
            float f5 = this.g;
            canvas.drawCircle(f3 - f5, f3 - f5, f3 - f5, this.f2542a);
            return;
        }
        super.onDraw(canvas);
    }
