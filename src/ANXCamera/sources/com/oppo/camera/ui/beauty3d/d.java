...
public class d implements View.OnClickListener, OppoNumSeekBar.b {
    private a A = null;
    private a B = null;
    private a C = null;
    private a D = null;
    ...
    private View.OnTouchListener aA = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (actionMasked != 0) {
                ...
                boolean unused = d.this.ar = true;
                if (d.this.H != null) {
                    d.this.H.a("com.oppo.beauty3d.custom.mode", d.this.au);
                }
                if (d.this.K != null) {
    ...
    private C0068d aB = new C0068d() {
        public void a(View view, int i) {
            com.oppo.camera.d.a("Beauty3DEditUI", "onItemClick, position: " + i);
            d.this.H();
            if (i == 0) {
                d.this.b(0);
            } else if (i == 1) {
    ...
    private class a implements GestureDetector.OnGestureListener {
        ...
        public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DGestureListener, onFling");
            return true;
        }

        public void onLongPress(MotionEvent motionEvent) {
            com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DGestureListener, onLongPress");
            if (d.this.i == 2) {
                d.this.H.a("com.oppo.beauty3d.custom.mode", d.this.at);
            }
        }

        public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            if (!(motionEvent == null || motionEvent2 == null)) {
                com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DGestureListener, onScroll, e1.X: " + motionEvent.getX() + ", e2.X:" + motionEvent2.getX());
                if (Math.abs((int) (motionEvent2.getX() - motionEvent.getX())) < 10) {
                    return true;
                }
                d.this.b(false);
                int unused = d.this.al = com.oppo.camera.c.c.a().a(motionEvent2.getRawX(), com.oppo.camera.o.d.N(), d.this.an, d.this.al);
                d.this.H.a("com.oppo.beauty3d.analyses.rotatedegree", new int[]{d.this.al});
        ...
        public void onShowPress(MotionEvent motionEvent) {
            com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DGestureListener, onShowPress");
        }
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            ...
            com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DGestureListener, onSingleTapUp, x: " + y + ", y: " + x);
            if (d.this.i == 2) {
                boolean unused = d.this.ao = false;
                boolean unused2 = d.this.aq = false;
                d.this.H.a("com.oppo.beauty3d.custom.position", new int[]{(int) y, (int) x});
            }
            return true;
        }
    }
    ...
    private class b extends RecyclerView.a<a> {
        ...
        public class a extends RecyclerView.w implements View.OnClickListener {
            public BorderRoundImageView q = null;
            public TextView r = null;
            public C0068d s = null;

            public a(View view, C0068d dVar) {
                super(view);
                this.q = (BorderRoundImageView) view.findViewById(R.id.edit_item_view);
                this.r = (TextView) view.findViewById(R.id.edit_item_title);
                this.s = dVar;
            ...
            public void onClick(View view) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "ViewHolder, onClick, Position: " + f());
                b.this.d.set(f(), true);
                b.this.e();
                C0068d dVar = this.s;
                if (dVar != null) {
        ...
        public b(List<c> list, C0068d dVar) {
            this.c = list;
            this.f2562a = dVar;
        ...
        public a b(ViewGroup viewGroup, int i) {
            ...
            com.oppo.camera.d.a("Beauty3DEditUI", "ViewHolder, onCreateViewHolder, Tag: " + i);
            return new a(inflate, this.f2562a);
        }

        public void a(a aVar, int i) {
            aVar.q.setImageDrawable(this.c.get(i).f2564a);
            aVar.r.setText(this.c.get(i).f2565b);
            if (this.d.get(i).booleanValue()) {
                aVar.r.setTextColor(d.this.f.getResources().getColor(R.color.beauty3d_text_color));
                aVar.q.setHighLight(true);
                return;
            }
            aVar.r.setTextColor(d.this.f.getColor(R.color.camera_white));
            aVar.q.setHighLight(false);
        }
    ...
    private class e extends LinearLayoutManager {
        ...
        private void a(RecyclerView.p pVar, int i, int i2, int i3, int[] iArr) {
            ...
            if (c != null) {
                ...
                c.measure(ViewGroup.getChildMeasureSpec(i2, E() + G(), jVar.width), ViewGroup.getChildMeasureSpec(i3, F() + H(), jVar.height));
        ...
        public void a(RecyclerView.p pVar, RecyclerView.t tVar, int i, int i2) {
            ...
            for (int i5 = 0; i5 < J(); i5++) {
                a(pVar, i5, View.MeasureSpec.makeMeasureSpec(i5, 0), View.MeasureSpec.makeMeasureSpec(i5, 0), this.f2568b);
                if (h() == 0) {
    ...
    public d(Activity activity, i iVar, RelativeLayout relativeLayout) {
        ...
        this.f2552a = new Point(400, 400);
        this.e = new Point(400, 1000);
        this.f2553b = new Point(400, STStickerMakeupParamType.ST_STICKER_PARAM_MAKEUP_FLOAT_SCALE);
        this.d = new Point(400, 1000);
        this.c = new Point(400, 400);
        com.oppo.camera.c.c.a().a(this.f);
    }
    ...
    private void B() {
        ...
        this.t.a((RecyclerView.h) new f((int) this.f.getResources().getDimension(R.dimen.beauty3d_edit_recyclerview_item_space)));
        K();
    }
    ...
    private void G() {
        com.oppo.camera.d.a("Beauty3DEditUI", "showSeekBar");
        F();
        g();
        ...
        if (i2 == 1) {
            ...
            this.w.c(this.D.b()).d(this.D.a()).a(this.D.f2547b).b(this.D.c).postInvalidate();
            this.x.c(this.C.b()).d(this.C.a()).a(this.C.f2547b).b(this.C.c).postInvalidate();
        } else if (i2 == 2) {
            c((int) R.id.up_seekbar_container, 4);
            this.x.c(this.B.b()).d(this.B.a()).a(this.B.f2547b).b(this.B.c).postInvalidate();
        } else if (i2 == 3) {
            c((int) R.id.up_seekbar_container, 0);
            this.w.c(this.y.b()).d(this.y.a()).a(this.y.f2547b).b(this.y.c).postInvalidate();
            this.x.c(this.z.b()).d(this.z.a()).a(this.z.f2547b).b(this.z.c).postInvalidate();
        } else if (i2 == 4) {
            c((int) R.id.up_seekbar_container, 4);
            this.x.c(this.E.b()).d(this.E.a()).a(this.E.f2547b).b(this.E.c).postInvalidate();
        } else if (i2 == 5) {
            c((int) R.id.up_seekbar_container, 4);
            this.x.c(this.A.b()).d(this.A.a()).a(this.A.f2547b).b(this.A.c).postInvalidate();
        }
    }

    /* access modifiers changed from: private */
    public void H() {
        com.oppo.camera.d.a("Beauty3DEditUI", "hideAllSeekBar");
        View view = this.I;
        if (view != null) {
    ...
    private void I() {
        new b.a(this.f, 2131755476).d(1).c((int) R.string.beauty3d_give_up_customize_face, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        }).b((int) R.string.beauty3d_cancel, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
        }).b().show();
    ...
    private void J() {
        ...
        com.oppo.camera.o.d.Z().postDelayed(new Runnable() {
            public void run() {
                d.this.r();
            }
        }, 3000);
    ...
    private void M() {
        ...
        a aVar2 = this.D;
        if (aVar2 != null) {
            this.av[2] = aVar2.f2546a;
        }
        a aVar3 = this.B;
        if (aVar3 != null) {
            this.av[3] = aVar3.f2546a;
        }
        a aVar4 = this.z;
        if (aVar4 != null) {
            this.av[4] = aVar4.f2546a;
        }
        a aVar5 = this.y;
        if (aVar5 != null) {
            this.av[5] = aVar5.f2546a;
        }
        a aVar6 = this.E;
        if (aVar6 != null) {
            this.av[6] = aVar6.f2546a;
        }
        a aVar7 = this.A;
        if (aVar7 != null) {
            this.av[7] = aVar7.f2546a;
        }
        com.oppo.camera.d.a("Beauty3DEditUI", "updateFiveSenseParams, updateFiveSenseParams: " + this.av[0] + ", " + this.av[1] + ", " + this.av[2] + ", " + this.av[3] + ", " + this.av[4] + ", " + this.av[5] + ", " + this.av[6] + ", " + this.av[7]);
        i iVar = this.H;
        if (iVar != null) {
            iVar.a("com.oppo.beauty3d.custom.style", this.av);
        }
    }
    ...
    private void a(View view, Point point, boolean z2) {
        if (view == null || point == null) {
            com.oppo.camera.d.e("Beauty3DEditUI", "updateFiveSenseViewLayout, view or point null");
            return;
        }
    ...
    private void d(int[] iArr) {
        if (iArr != null && iArr.length == 7) {
            ...
            if (aVar != null) {
                aVar.a(a(0));
                this.C.f2546a = iArr[0];
            }
            a aVar2 = this.D;
            if (aVar2 != null) {
                aVar2.a(a(1));
                this.D.f2546a = iArr[1];
            }
            a aVar3 = this.B;
            if (aVar3 != null) {
                aVar3.a(a(2));
                this.B.f2546a = iArr[2];
            }
            a aVar4 = this.z;
            if (aVar4 != null) {
                aVar4.a(a(3));
                this.z.f2546a = iArr[3];
            }
            a aVar5 = this.y;
            if (aVar5 != null) {
                aVar5.a(a(4));
                this.y.f2546a = iArr[4];
            }
            a aVar6 = this.E;
            if (aVar6 != null) {
                aVar6.a(a(5));
                this.E.f2546a = iArr[5];
            }
            a aVar7 = this.A;
            if (aVar7 != null) {
                aVar7.a(a(6));
                this.A.f2546a = iArr[6];
            }
        }
    }
    ...
    private void x() {
        ...
        if (view != null) {
            ...
            if (com.oppo.camera.o.d.S()) {
                int R2 = com.oppo.camera.o.d.R() - dimension2;
                if (R2 > 0) {
                    i2 = R2;
                }
            }
            ...
            com.oppo.camera.d.a("Beauty3DEditUI", "refreshBottomLayout, bottomMargin: " + i2 + ", height: " + dimension);
    ...
    private void z() {
        com.oppo.camera.d.a("Beauty3DEditUI", "initPreview");
        ...
        if (!this.O) {
            ...
            if (relativeLayout2 != null) {
                relativeLayout2.addView(this.Q, -1, -1);
                ...
                b(false);
                a(this.R, this.f2552a, false);
                a(this.S, this.f2553b, false);
    ...
    public int a(int i2) {
        ...
        int[] iArr = sparseArray.get(this.am);
    ...
    public void a(int i2, int i3) {
        com.oppo.camera.d.a("Beauty3DEditUI", "setSeekBarProgress: progress: " + i3 + ", mTouchLocation: " + this.h);
        int i4 = this.h;
        if (i4 != 1) {
            if (i4 == 2) {
                this.B.b(i3);
    ...
    public void a(OppoNumSeekBar oppoNumSeekBar, int i2, boolean z2) {
        com.oppo.camera.d.a("Beauty3DEditUI", "onProgressChanged, progress: " + i2);
    ...
    public void a(String str) {
        ...
        if (cameraScreenHintView != null) {
            ...
            this.ak.a(str, true, false, 0, R.color.screen_hint_text_color);
        }
    }
    ...
    public void a(String[] strArr) {
        if (strArr != null && strArr.length == 5) {
            ...
            if (!(oppoTextView == null || strArr[0] == null || strArr[0].equals(oppoTextView.getText()))) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseTitles, update CheekBone");
            }
            ...
            if (!(oppoTextView2 == null || strArr[1] == null || strArr[1].equals(oppoTextView2.getText()))) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseTitles, update Face");
            }
            ...
            if (!(oppoTextView3 == null || strArr[2] == null || strArr[2].equals(oppoTextView3.getText()))) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseTitles, update Chin");
            }
            ...
            if (!(oppoTextView4 == null || strArr[3] == null || strArr[3].equals(oppoTextView4.getText()))) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseTitles, update Nose");
            }
            ...
            if (oppoTextView5 != null && strArr[4] != null && !strArr[4].equals(oppoTextView5.getText())) {
                ...
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseTitles, update Eye");
            }
        }
    }
    ...
    public void b(OppoNumSeekBar oppoNumSeekBar, int i2) {
        com.oppo.camera.d.a("Beauty3DEditUI", "getProgressOnActionUp, progress: " + i2 + ", mDownProgress: " + this.ap);
        if (this.ap != i2) {
            this.aj.a(new b(this.h, oppoNumSeekBar.getId(), i2));
            this.aj.e();
            e(false);
    ...
    public void b(int[] iArr) {
        ...
        if (iArr != null && iArr.length >= 10 && this.ar) {
            ...
            int i8 = 1440 - iArr[6];
            int i9 = 1080 - iArr[7];
            if (!(this.f2553b.y == i8 && this.f2553b.x == i9)) {
                Point point4 = this.f2553b;
                point4.y = i8;
                point4.x = i9;
                z2 = true;
            }
            int i10 = 1440 - iArr[8];
            int i11 = 1080 - iArr[9];
            if (!(this.f2552a.y == i10 && this.f2552a.x == i11)) {
                Point point5 = this.f2552a;
                point5.y = i10;
                point5.x = i11;
                z2 = true;
            }
            if (z2) {
                com.oppo.camera.d.a("Beauty3DEditUI", "setFiveSenseViewParams, result: " + iArr[0] + ", " + iArr[1] + ", " + iArr[2] + ", " + iArr[3] + ", " + iArr[4] + ", " + iArr[5] + ", " + iArr[6] + ", " + iArr[7] + ", " + iArr[8] + ", " + iArr[9]);
                b(false);
                a(this.R, this.f2552a, false);
                a(this.S, this.f2553b, false);
                a(this.T, this.d, false);
    ...
    public void c(int[] iArr) {
        if (iArr != null && iArr.length >= 2 && iArr[0] == 2) {
            int i2 = iArr[1];
            com.oppo.camera.d.a("Beauty3DEditUI", "upParams, location: " + i2 + ", mTouchLocation: " + this.h + ", mbRedo: " + this.ao + ", mbChangeStyle: " + this.aq);
            if (2 == this.i && (this.h == i2 || this.ao || this.aq)) {
                return;
            }
            if (i2 == 2 || i2 == 1 || i2 == 3 || i2 == 5 || i2 == 4) {
                com.oppo.camera.d.a("Beauty3DEditUI", "update, location: " + i2);
                this.h = i2;
                G();
            }
        }
    ...
    public void h() {
        if (this.M != null) {
            com.oppo.camera.d.a("Beauty3DEditUI", "onUpdateStyleViewPosition, mChoseStyle: " + this.am);
            List a2 = this.M.d;
    ...
    public void m() {
        ...
        b a2 = this.aj.a();
        this.aj.b(a2);
        com.oppo.camera.d.a("Beauty3DEditUI", "Beauty3DEditAction, mValueOwner: " + a2.f2549b + ", mValueLocation: " + a2.f2548a + ", mSbValue: " + a2.c);
        this.h = a2.f2548a;
        a(a2.f2549b, a2.c);
        M();
        G();
        ...
        if (id != R.id.custom_rescan) {
            switch (id) {
                ...
                case R.id.face3d_customize:
                    i iVar2 = this.H;
                    if (iVar2 != null) {
                        iVar2.a("com.oppo.beauty3d.mode", new int[]{3});
                    }
                    J();
                    return;
                ...
                case R.id.face3d_save:
                    ...
                    i iVar3 = this.H;
                    if (iVar3 != null) {
                        iVar3.a("com.oppo.beauty3d.custom.mode", this.as);
                        this.H.b();
                    }
                    E();
                    return;
    ...
    public HashMap<String, int[]> q() {
        ...
        com.oppo.camera.d.a("Beauty3DEditUI", "getBeauty3DEditCurrParams, mChoseStyle: " + this.am + ", mDegree: " + this.al);
        if (this.i != 1) {
            hashMap.put("com.oppo.beauty3d.custom.style", this.av);
        }
        hashMap.put("com.oppo.beauty3d.analyses.rotatedegree", new int[]{this.al});
        return hashMap;
    }
