...
public class f implements View.OnClickListener, View.OnTouchListener {
    ...
    public Handler O = new Handler() {
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                d.a("Beauty3DGuideScanUI", "handleMessage, mbNeedUpdate: " + f.this.l);
    ...
    private void c(int i2, boolean z2) {
        d.a("Beauty3DGuideScanUI", "updateBeauty3DControlPanelBgColor, color: " + i2 + ", needAnimation: " + z2);
        View view = this.j;
        if (view != null) {
            if (z2) {
                com.oppo.camera.o.d.a(view, i2, 200, (BaseInterpolator) null, (Animator.AnimatorListener) null);
            } else {
    ...
    public void d(int i2) {
        ...
        if (hVar2 != null && !hVar2.c()) {
            ...
            d.a("Beauty3DGuideScanUI", "startScanLoadAnim, mScanLoadAnimation start");
            this.t.d();
            ...
            d.a("Beauty3DGuideScanUI", "startScanLoadAnim, scaleAnim start");
            this.G.start();
        }
    }
    ...
    private void o() {
        if (this.j == null) {
            ...
            if (!this.k) {
                ...
                layoutParams.height = (int) this.e.getResources().getDimension(R.dimen.control_panel_layout_height);
    ...
    private int p() {
        return com.oppo.camera.o.d.S() ? com.oppo.camera.o.d.R() : this.e.getResources().getDimensionPixelSize(R.dimen.beauty3d_scan_cancel_margin_bottom);
    }
    ...
    public void a(int i2) {
        if (i2 == 0) {
            View view = this.m;
            if (view != null && this.f2571a) {
                this.g.removeView(view);
                d.a("Beauty3DGuideScanUI", "onViewDismiss, mRootView.removeGuideView.");
                this.m = null;
                this.f2571a = false;
                e eVar = this.u;
                if (eVar != null) {
            ...
            View view2 = this.n;
            if (view2 != null && this.f2572b) {
                this.f.removeView(view2);
                d.a("Beauty3DGuideScanUI", "onViewDismiss, mRootPreviewView.removeScanView.");
                this.n = null;
                this.f2572b = false;
            }
            View view3 = this.h;
    ...
    public void a(int i2, boolean z2, int i3, int i4) {
        if (this.e != null && this.f != null) {
            i();
            d.a("Beauty3DGuideScanUI", "showGuideView, mbGuideAdd: " + this.f2571a);
            if (!this.f2571a) {
    ...
    public void a(ObjectAnimator objectAnimator, final View view) {
        if (view != null && view.getVisibility() == 0) {
            if (objectAnimator == null || !objectAnimator.isRunning()) {
                d.a("Beauty3DGuideScanUI", "playFadeOutArrowAnim");
            ...
            d.a("Beauty3DGuideScanUI", "playFadeOutArrowAnim, animator is Running");
        }
    }
    ...
    public void a(View view, String str) {
        ...
        if (view != null && view.getVisibility() != 0) {
            ...
            d.a("Beauty3DGuideScanUI", "playStartArrowAnim");
    ...
    public void a(boolean z2, final boolean z3) {
        if (this.d) {
            d.a("Beauty3DGuideScanUI", "stop3DScan, mbExiting: " + this.d + " return");
            return;
        }
        this.d = true;
        this.c = false;
        ...
        if (z2) {
            ...
            ofFloat.addListener(new Animator.AnimatorListener() {
                public void onAnimationCancel(Animator animator) {
                    d.a("Beauty3DGuideScanUI", "stop3DScan, onAnimationCancel");
                }

                public void onAnimationEnd(Animator animator) {
                    d.a("Beauty3DGuideScanUI", "stop3DScan, onAnimationEnd");
    ...
    public void b(int i2, boolean z2, int i3, int i4) {
        if (this.e != null && this.f != null) {
            j();
            k();
            d.a("Beauty3DGuideScanUI", "showBeauty3DScanView, mbScanAdd: " + this.f2572b);
            this.n.setVisibility(0);
            if (!this.f2572b) {
    ...
    public void c() {
        d.a("Beauty3DGuideScanUI", "onScanViewHide");
        f();
        g();
        ...
        if (this.z != null) {
            d.a("Beauty3DGuideScanUI", "onScanViewHide, reset scanCircle");
    ...
    public void c(int i2) {
        if (i2 == R.string.beauty3d_turn_to_left || i2 == R.string.beauty3d_continue_turn_to_left) {
            d.a("Beauty3DGuideScanUI", "updateArrow, turn left");
            ...
            d.a("Beauty3DGuideScanUI", "updateArrow, turn right");
            a((View) this.p, "translationX");
            a(this.D, (View) this.o);
            a(this.F, (View) this.q);
        } else if (i2 == R.string.beauty3d_turn_to_up) {
            d.a("Beauty3DGuideScanUI", "updateArrow, turn up");
    ...
    public void h() {
        d.a("Beauty3DGuideScanUI", "scanComplete");
        AnimatorSet animatorSet = this.H;
        if (animatorSet == null || !animatorSet.isRunning()) {
            ...
            this.H.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    d.a("Beauty3DGuideScanUI", "scanComplete, onAnimationEnd, mbScanCompleteCancel: " + f.this.I);
        ...
        d.a("Beauty3DGuideScanUI", "scanComplete,isRunning return");
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.start_face_scan:
                a(0);
                d.a("Beauty3DGuideScanUI", "onClick, startScan, disMiss Guide.");
                e eVar = this.u;
                if (eVar != null) {
                    eVar.b();
                    return;
            ...
            case R.id.start_scan:
                ...
                e eVar2 = this.u;
                if (eVar2 != null) {
                    eVar2.a("com.oppo.beauty3d.scan.state", new int[]{1});
                    return;
                }
                return;
            default:
