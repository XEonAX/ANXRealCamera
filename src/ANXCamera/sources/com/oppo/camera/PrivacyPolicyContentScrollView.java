...
public class PrivacyPolicyContentScrollView extends ScrollView {
    ...
    public PrivacyPolicyContentScrollView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1814a = obtainStyledAttributes.getDimensionPixelOffset(0, getResources().getDimensionPixelSize(R.dimen.privacy_policy_text_max_height));
        obtainStyledAttributes.recycle();
    }

    /* access modifiers changed from: protected */
    public void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i2), this.f1814a), View.MeasureSpec.getMode(i2)));
    }
}
