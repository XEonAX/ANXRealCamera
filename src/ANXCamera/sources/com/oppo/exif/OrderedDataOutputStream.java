...
class OrderedDataOutputStream extends FilterOutputStream {
    ...
    public OrderedDataOutputStream writeRational(OppoRational oppoRational) throws IOException {
        writeInt((int) oppoRational.getNumerator());
        writeInt((int) oppoRational.getDenominator());
        return this;
    }
