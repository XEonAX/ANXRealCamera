...
class OppoCountedDataInputStream extends FilterInputStream {
    static final /* synthetic */ boolean $assertionsDisabled = false;
    private final byte[] mByteArray = new byte[8];
    private final ByteBuffer mByteBuffer = ByteBuffer.wrap(this.mByteArray);
    private int mCount = 0;

    protected OppoCountedDataInputStream(InputStream inputStream) {
        super(inputStream);
    }
    ...
    public int readUnsignedShort() throws IOException {
        return readShort() & OppoExifInterface.ColorSpace.UNCALIBRATED;
    }
