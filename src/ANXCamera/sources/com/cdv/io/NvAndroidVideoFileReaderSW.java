...
public class NvAndroidVideoFileReaderSW {
    ...
    private boolean m_onlyDecodecKeyFrame = false;
                ...
                if (dequeueOutputBuffer == -3) {
                    ...
                    if (this.m_bufferInfo.size != 0) {
                        ...
                        if (j != Long.MIN_VALUE) {
                            ...
                            if (z4 || this.m_timestampOfLastDecodedFrame < this.m_duration - 100000) {
                                z3 = false;
                            } else {
                                z4 = true;
                                z3 = true;
                            }
                            if (this.m_onlyDecodecKeyFrame) {
                                z = z3;
                                z2 = true;
                            } else {
                                z2 = z4;
    ...
    private void ParseMediaFormat(MediaFormat mediaFormat) {
        ...
        int i3;
        int i4;
        if (mediaFormat.containsKey(CameraStatisticsUtil.IMAGE_WIDTH) && mediaFormat.containsKey(CameraStatisticsUtil.IMAGE_HEIGHT) && mediaFormat.containsKey("color-format")) {
            int integer = mediaFormat.getInteger(CameraStatisticsUtil.IMAGE_WIDTH);
            int integer2 = mediaFormat.getInteger(CameraStatisticsUtil.IMAGE_HEIGHT);
    ...
    public void CloseFile() {
        ...
        if (mediaExtractor != null) {
            ...
            this.m_onlyDecodecKeyFrame = false;
        }
    }
