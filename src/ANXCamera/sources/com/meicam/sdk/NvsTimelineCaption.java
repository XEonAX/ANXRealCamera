...
public class NvsTimelineCaption extends NvsFx {
    ...
    private native int nativeGetFontWeight(long j);
    ...
    private native void nativeSetFontWeight(long j, int i);
    ...
    public int getFontWeight() {
        NvsUtils.checkFunctionInMainThread();
        return nativeGetFontWeight(this.m_internalObject);
    }
    ...
    public void setFontWeight(int i) {
        NvsUtils.checkFunctionInMainThread();
        nativeSetFontWeight(this.m_internalObject, i);
    }
