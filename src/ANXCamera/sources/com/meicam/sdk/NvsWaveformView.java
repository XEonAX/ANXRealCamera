...
public class NvsWaveformView extends View implements NvsWaveformDataGenerator.WaveformDataCallback {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode() && nvsWaveformView.m_audioFileDuration > 0) {
            if (nvsWaveformView.m_needUpdateWaveformData) {
                NvsWaveformDataGenerator nvsWaveformDataGenerator = nvsWaveformView.m_waveformDataGenerator;
                if (nvsWaveformDataGenerator != null) {
            ...
            if (nvsWaveformView.m_samplesPerGroup > 0) {
                float[] fArr = nvsWaveformView.m_leftWaveformData;
                if (fArr != null) {
