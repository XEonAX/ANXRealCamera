...
public class NvsStreamingContext {
    ...
    public static final String COMPILE_DISABLE_OPERATING_RATE = "disable operating rate";
    ...
    public static NvsStreamingContext init(Context context, String str, int i) {
        ...
        String str2 = "QT_BLOCK_EVENT_LOOPS_WHEN_SUSPENDED=0" + "\tHOME=" + context.getFilesDir().getAbsolutePath();
        String str3 = str2 + "\tTMPDIR=" + context.getFilesDir().getAbsolutePath();
        try {
            ...
            if (nativeInitJNI()) {
                ...
                if (!nativeInit("<meishesdk>", str3, i)) {
                    return null;
                }
