...
public class t extends b {
    public t(Resources resources, Context context) {
        super(resources, p.a("dehaze"), context);
    ...
    public void d() {
        super.d();
        int glGetUniformLocation = GLES20.glGetUniformLocation(this.x, "dehazeMap");
        GLES20.glActiveTexture(33985);
        GLES20.glBindTexture(3553, this.u.dehazeTexture.c);
        GLES20.glUniform1i(glGetUniformLocation, 1);
        GLES20.glUniform3fv(GLES20.glGetUniformLocation(this.x, "average"), 1, this.u.thresholdAverage, 0);
