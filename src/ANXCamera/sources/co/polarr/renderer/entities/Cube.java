...
public class Cube {
    ...
    private static boolean compareTwoByteArray(byte[] bArr, byte[] bArr2) {
    ...
    public static byte[] extractAndCheckLutRawDat(InputStream inputStream) {
        try {
            ...
            if (!compareTwoByteArray(bArr4, a2)) {
                return new byte[256];
            }
                ...
                if (readLine == null) {
                    ...
                    if (!readLine.startsWith("TITLE")) {
                        if (readLine.startsWith("LUT_3D_SIZE")) {
                            ...
                            if (readLine.startsWith("0") || readLine.startsWith(MenuClickMsgData.VALUE_SLOGAN_CONTENT_EXIST) || readLine.startsWith(".")) {
