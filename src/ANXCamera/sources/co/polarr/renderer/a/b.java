...
public class b {
    ...
    public b(float[] fArr, float[] fArr2) {
        ...
        this.f1109a = Arrays.copyOf(fArr, length);
        this.f1110b = Arrays.copyOf(fArr4, length);
        this.c = fArr6;
    }

    public float a(int i) {
        int length = this.f1109a.length - 2;
        int i2 = length;
        while (true) {
            if (length > 0) {
                if (i2 < 0) {
            ...
            if (this.f1109a[i2] <= ((float) i)) {
                break;
            }
            i2 = length <= 0 ? i2 + 1 : i2 - 1;
        }
        float[] fArr = this.f1109a;
        int i3 = i2 + 1;
