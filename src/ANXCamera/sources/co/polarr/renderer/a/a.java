...
public class a {
    ...
    public a(float[] fArr, float[] fArr2, Float f, Float f2) {
        ...
        if (fArr3 != null && fArr4 != null) {
            ...
            this.f1107a = Arrays.copyOf(fArr3, length + 1);
            this.f1108b = Arrays.copyOf(fArr4, length);
            this.c = fArr11;
    ...
    public float a(int i) {
        try {
            int length = this.f1107a.length - 1;
            int i2 = length;
            while (true) {
                if (length > 0) {
                    if (i2 < 0) {
                ...
                if (this.f1107a[i2] <= ((float) i)) {
                    break;
                }
                i2 = length <= 0 ? i2 + 1 : i2 - 1;
            }
            float f = ((float) i) - this.f1107a[i2];
            if (this.f1108b.length <= i2) {
                return -1.0f;
            }
            if (this.d.length <= i2) {
                return -1.0f;
            ...
            double d2 = (double) f;
            return (float) (((double) (this.f1108b[i2] + (this.c[i2] * f))) + (((double) this.d[i2]) * Math.pow(d2, 2.0d)) + (((double) this.e[i2]) * Math.pow(d2, 3.0d)));
