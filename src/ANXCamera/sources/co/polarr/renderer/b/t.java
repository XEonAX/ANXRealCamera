...
public class t {
    ...
    public static float a(float[] fArr, float[][] fArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            e(fArr, fArr2[i2], fArr2[i]);
            f = Math.min(f, e(fArr, fArr2[i2], fArr2[i]));
            i = i2;
        }
        return f;
    }
    ...
    public static boolean a(Object obj, Object obj2) {
        ...
        if (obj == null || obj2 != null) {
            return k.a(obj).equals(k.a(obj2));
        }
        return false;
    }
    ...
    public static float[] a(float[] fArr, float f) {
        double d = (double) ((float) (((double) f) * RADIAN));
    ...
    private static float e(float[] fArr, float[] fArr2, float[] fArr3) {
