...
public final class f {
    ...
    public static final boolean f1408a = (Build.VERSION.SDK_INT < 21);

    /* renamed from: b  reason: collision with root package name */
    private static final PorterDuff.Mode f1409b = PorterDuff.Mode.SRC_IN;
    ...
    private ColorStateList b(Context context) {
        return new ColorStateList(new int[][]{e.f1406a, e.d, e.g}, new int[]{e.c(context, R.attr.colorTintControlDisabled), e.a(context, R.attr.colorTintControlPressed), e.a(context, R.attr.colorTintControlNormal)});
    }
    ...
    public Drawable a(int i, boolean z) {
        ...
        if (c2 != null) {
            drawable = androidx.core.graphics.drawable.a.f(a2);
