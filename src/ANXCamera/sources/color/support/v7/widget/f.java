...
class f extends c implements View.OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            this.f1460a = (TextView) view.findViewById(16908308);
            this.f1461b = (TextView) view.findViewById(16908309);
    ...
    public f(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f1460a != null) {
            a(aVar.f1460a, (CharSequence) a(cursor, this.s));
        }
        if (aVar.f1461b != null) {
            ...
            } else if (aVar.f1460a != null) {
                aVar.f1460a.setSingleLine(true);
                aVar.f1460a.setMaxLines(1);
            }
            a(aVar.f1461b, b2);
        }
        if (aVar.c != null) {
        ...
        if (i3 == 2 || (i3 == 1 && (i2 & 1) != 0)) {
            ...
            aVar.e.setTag(aVar.f1460a.getText());
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (a2 != null) {
                ((a) a2.getTag()).f1460a.setText(e.toString());
            }
            return a2;
        }
    }
